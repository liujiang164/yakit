...
interface ExportImportProgress {
    Progress: number
    Verbose: string
}
...
type ImportExportWhichUse = "fingerprint"
...
const ImportExportModalInner = <T,>(props: ImportExportModalComProps<T>) => {
    const {getContainer, extra, whichUse, onCallback, filterData} = props
...
const ImportExportModal = memo(<T,>(props: ImportExportModalComProps<T>) => <ImportExportModalInner {...props} />)
